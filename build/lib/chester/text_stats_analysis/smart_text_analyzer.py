...
word_cloud_message = """
A word cloud displays the most frequently used words in a piece of text\n, with the size of the words indicating 
their frequency. \nIt provides a quick overview of the main themes and topics present in the data.
"""
