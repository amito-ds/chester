...
#
# #
df1 = load_data_chat_logs().assign(target='chat_logs').sample(150)
df2 = load_data_king_arthur().assign(target='wow').sample(150)
df3 = load_data_pirates().assign(target='pirate').sample(150)
df = pd.concat([df1,
                df2,
                df3])
# #
...
# best_model = model_cycle.running_all_models()
