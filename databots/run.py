...
from databots.code_development.develop_and_test import developer, qa
...
def run(text, file_prefix="/Users/amitosi/PycharmProjects/chester/databots", python_file="generated_code.py"):
